		...
		<table>
			<tr>
				...
				<td><input type='text' name='mem_id' disabled="disabled"
					name="mem_id" value='${memberInfo.mem_id }' /></td>
			</tr>
			<tr>
				<td>패스워드</td>
			...
			<tr>
				...
				<td><input type='text' name='mem_name'
					value='${memberInfo.mem_name}' disabled="disabled" /></td>
			</tr>
			<tr>
				<td>주민등록번호</td>
				<td><input type='text' name='mem_regno1'
					value='${memberInfo.mem_regno1 }' disabled="disabled" /> <input
					type='text' name='mem_regno2' value='${memberInfo.mem_regno2 }'
					disabled="disabled" /></td>
			</tr>
			<tr>
				<td>생년월일</td>
				<td><input type='text' value='${memberInfo.mem_bir }'
					name='mem_bir' /></td>
			</tr>
			<tr>
				<td>우편번호</td>
				<td><input type='text' value='${memberInfo.mem_zip }'
					name='mem_zip' /></td>
			</tr>
			<tr>
				<td>주소</td>
				<td><input type='text' value='${memberInfo.mem_add1 }'
					name='mem_add1' />- <input type='text'
					value='${memberInfo.mem_add2 }' name='mem_add2' /></td>
			</tr>
			<tr>
				<td>집전화번호</td>
			...
			<tr>
				<td colspan='2'><input type='submit' value='수정' /> <input
					type="button" value="삭제" id="delete" /> <input type='reset'
