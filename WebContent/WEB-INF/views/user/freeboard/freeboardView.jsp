...
$(function(){
    ...
    $('form[name=freeboardView]').submit(function() {
		...
		$(this).attr('action', '/guronsan/controller/user/updateFreeboardAction.do');
    ...
    $('#btnDelete').on('click', function() {
    	...
    	if(eval('${!empty LOGIN_MEMBERINFO}')){
    		if('${LOGIN_MEMBERINFO.mem_id}'== '${freeboardInfo.bo_writer}'){
				...
				$(location).attr('href', '/guronsan/controller/user/deleteFreeboardAction.do?bo_no=${freeboardInfo.bo_no}');
    		}else{
	    		flag = false;
    		}
    	}else{
