               ...
               <li class="dropdown">
                ...
                <li class="dropdown">
                   <label for="inputName" class="control-label text-yellow">패스워드 :</label>
                    <input type="password"    name="mem_pass" id="mem_pass" placeholder="패스워드를 입력해주세요." 
                     class="text-yellow" />
               </li>
               <li>&nbsp;</li>   
                 <li class="dropdown">
                    <button type="button" class="btn btn-warning btn-sm" id="loginBTN" name="loginbtn">로그인</button>
                    <button type="button" class="btn btn-debug btn-sm" id="memberRegist" name="registbtn">회원가입</button>
                </li>
            </ul>       
         </div>
         </c:if>  
